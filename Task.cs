...
public class Database{
    ...
    public people[] one = new People[50];

    public void AddStudent(Student student){
        one[_currentIndex++] = student;
    } 

    public void AddStaff(Staff staff){
        one[_currentIndex++] = staff;
    }

    public void AddPerson(People people){
        one[_currentIndex++] = people;
    } 
    public void PrintAll(){
        foreach(var people in one){
            people?.Print();
        }
    } 
...
public class Task
{
    private static void Main()
    {
        ...
        while(true){
            Console.WriteLine("1.(Student 2.(Staff 3.(People 4.(Print All");
            ...
            case 3:
                ...
                try{
                    var person = new People(name3, age3);
                    database.AddPerson(people);
                }
                catch(Exception e)
                {
                    Console.WriteLine(e.Message);
